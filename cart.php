							...
							<tr class="table-row">
								<td>
									<div class="product-image">
										<img src="./adminDashOldHouse/uploads/<?php echo htmlspecialchars($product['img_path'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($product['pro_name'], ENT_QUOTES, 'UTF-8'); ?>">
									</div>
								</td>
